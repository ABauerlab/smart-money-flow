      ...
      >
        ...
        <div className="border border-white/10 bg-white/[0.02] backdrop-blur-xl p-8 space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-[#555] uppercase tracking-widest">ou</span>
            <div className="flex-1 h-px bg-white/10" />
          </div>
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            <div className="relative">
              ...
              <Input
                ...
                required
                className="pl-10 h-12 bg-white/5 border-white/10 text-white placeholder:text-[#555]"
              />
            </div>
            <div className="relative">
              ...
              <Input
                ...
                required
                minLength={6}
                className="pl-10 pr-10 h-12 bg-white/5 border-white/10 text-white placeholder:text-[#555]"
              />
              <button
                type="button"
